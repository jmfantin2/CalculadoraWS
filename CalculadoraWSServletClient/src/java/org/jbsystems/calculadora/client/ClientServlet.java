 ...
 */
package org.jbsystems.calculadora.client;
...
import org.jbsystems.calculadora.CalculadoraWS_Service;
...
public class ClientServlet extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/CalculadoraWS/CalculadoraWS.wsdl")
    ...
    private double getQuotient(double a, double b) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        org.jbsystems.calculadora.CalculadoraWS port = service.getCalculadoraWSPort();
        return port.getQuotient(a, b);
    }
